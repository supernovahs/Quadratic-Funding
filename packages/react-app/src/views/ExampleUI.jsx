...
export default function ExampleUI({
  ...
  // const p1 = useContractReader(readContracts, "YourContract", "P1Allocation");
  // const p2 = useContractReader(readContracts, "YourContract", "P2Allocation");
  // let p1edit;
  // let p2edit;

  // if (p1) {
  //   p1edit = ethers.BigNumber.from(p1).toNumber();
  //   console.log(p1edit);
  // }
  // if (p2) {
  //   p2edit = ethers.BigNumber.from(p1).toNumber();
  //   console.log(p2edit);
  // }
